...
trainingTestingData = data.frame(rm = BostonHousing2$rm, 
                                 lstat = BostonHousing2$lstat, cmedv = BostonHousing2$cmedv)

trainTestIndex = createDataPartition(x$rm, p = 0.8, list = FALSE)
```
...
ggplot(data.frame(x = trainingTestingData[-trainTestIndex,]$rm, y = testResults), 
